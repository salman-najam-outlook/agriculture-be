 ...
 *                   data:
 *                     type: object
 *                 example: { "success": true, "code": 200, "message": "Fetched successfully.", "data": [ { "id": 6, "name": "Solar", "recordId": "emoo100" }, { "id": 5, "name": "Wind Energy", "recordId": "emoo101" }, { "id": 4, "name": "Electricity", "recordId": "emoo102" }, { "id": 3, "name": "Fuel Based", "recordId": "emoo103" }, { "id": 2, "name": "Manual (Human Energy)", "recordId": "emoo104" } ] }
 */
...
router.post(
  ...
  async (req, res) => {
    try {
      let modeOfOperationExists = null;
      
      if(req.body.recordId){
        modeOfOperationExists = await db.EquipmentModeOfOperation.findOne({
          where: {
      ...
      if (modeOfOperationExists === null) {
        ...
        const modeOfOperation = await modeOfOperationExists.update({
          name: req.body.name
        });
