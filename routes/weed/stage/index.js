...
// * /weed/stage:
// *   post:
// *     summary: Create weed stage
// *     description: Create weed stage with name
// *     tags: [Weed stage]
// *     parameters:
// *       - in: header
// *         name: oauth-token
...
// *     responses:
// *       200:
// *         description: Returns the weed stage JSON
// *       500:
...
//       name: req.body.name
//     };
//     let result = await db.WeedStage.findOrCreate({
//       where: data,
//       defaults: data
//     });
//     return res.json(
//       successRespSync({
//         msg: success.WEED_STAGE_CREATED,
//         data: result[0],
//       })
//     );
//   } catch (err) {
...
* /weed/stage:
*   get:
*     summary: Get weed stage list
*     description: Get the list of weeding stages
*     tags: [Weed]
*     parameters:
*       - in: header
*         name: oauth-token
...
*     responses:
*       200:
*         description: Returns the list of weeding stages
*       500:
*         description: Server error
*/
