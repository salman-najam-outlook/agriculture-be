...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.bulkUpdate(
      "faq_sections",
      {
        nl: `\`${JSON.stringify([{"question":"Voor elk technisch probleem kunt u contact met ons opnemen via help@dimitra.io met een uitleg van uw probleem, of vul ons online formulier in dat te vinden is in de sectie Neem contact met ons op.","answer": ""}])}\``,
      },
      {
