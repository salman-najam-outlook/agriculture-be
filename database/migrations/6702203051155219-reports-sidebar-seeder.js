...
module.exports = {
  ...
  reports_parent.forEach((rp, index) => {
    let tmpObj = {}
    tmpObj.id = `super_admin_${rp.id}`
    tmpObj.name = rp.name
    tmpObj.parent_module_id = `super_admin`
  ...
  reports_parent.forEach((rp, index) => {
    perms.forEach(perm => {
      let tmpObj = {}
      tmpObj.id = `super_admin_${rp.id}_${perm}`
      tmpObj.role_id = "super_admin"
      tmpObj.module_id = `super_admin_${rp.id}`
