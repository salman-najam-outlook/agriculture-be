...
const options = [
  {
    ...
    unitList: [
      { abbvr: 'Grams', unitType: 'Grams', factor: null },
      { abbvr: 'Pounds', unitType: 'Pounds', factor: 453.592 },
      { abbvr: 'Kilograms', unitType: 'Kilograms', factor: 1000 },
      { abbvr: 'Tonnes', unitType: 'Tonnes', factor: 1000000 },
    ],
  },
];
