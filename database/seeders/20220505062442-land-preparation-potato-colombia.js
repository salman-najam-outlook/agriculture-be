...
const moduleId = 1,
  cropVarietyId = null,
  cropType = 'Potato-Colombia';

const recommendation = [
  {
    moduleAttrId: 1,
    recommendation: JSON.stringify(['Jul-Aug']),
  },
  {
    moduleAttrId: 2,
    recommendation: JSON.stringify([
      ...
      'Ridge and furrow planting(Land should ploughed at a depth of 20-25 cm and incorporate FYM during last ploughing):Furrows are opened perpendicular to the slope at a distance of 50-60 cm before planting.The whole or cut tubers are planted 15- 20 cm apart on the centre of the ridge at a depth of 5-10 cm and covered with soil.',
    ]),
  },
];
