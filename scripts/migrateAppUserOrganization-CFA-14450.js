  ...
  try {
    ...
    if (offlineFarmerIds.length) {
      const userMemberships = await db.sequelize.query(
        ...
        WHERE
          urmm.user_role_id = 'cacao_farmer'
...
const migrateConfigs = [
  {
    ...
    activationKeyId: 229780,
    oldActivationKeyId: 229447,
    // User ID of app users(can include technician)
    userId: 125777,
    email:'saramedeiros.agro@gmail.com',
    // New organization ID
    organizationId: 37,
  },
  // {
  //   // New activation key ID to assign
  //   activationKeyId: 232355,
  //   oldActivationKeyId: 229456,
  //   // User ID of app users(can include technician)
  //   userId: 125662,
  //   email:'evillacortareategui@gmail.com',
  //   // New organization ID
  //   organizationId: 38,
  // },
  // {
  //   // New activation key ID to assign
  //   activationKeyId: 232356,
  //   oldActivationKeyId: 226665,
  //   // User ID of app users(can include technician)
  //   userId: 127225,
  //   email:'niltonjl2020@gmail.com',
  //   // New organization ID
  //   organizationId: 38,
  // },
  // {
  //   // New activation key ID to assign
  //   activationKeyId: 232357,
  //   oldActivationKeyId: 226664,
  //   // User ID of app users(can include technician)
  //   userId: 126961,
  //   email:'randyvasquez2528@gmail.com',
  //   // New organization ID
  //   organizationId: 38,
  // },
];
