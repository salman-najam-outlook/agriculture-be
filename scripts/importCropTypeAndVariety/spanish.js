...
const spreadsheetId = '1KTBijrE1uwCYVaLkN0NN1SQOajzbIy1hTNHTGHa1cL8'; //spanish sheet id
const sheetName = 'spanish!A2:J'; //new sheet name

module.exports = async function importCropTypeAndVarietySpanish() {
  try {
