...
module.exports = (sequelize, DataTypes) => {
  class CropsTraceabilityLabels extends Model {
  ...
  CropsTraceabilityLabels.init(
    ...
    {
      sequelize,
      tableName: "crops_traceability_labels",
      modelName: "CropsTraceabilityLabels",
    }
  );
  return CropsTraceabilityLabels;
};
